...
angular.module('angularTranslateApp', ['pascalprecht.translate'])
  .config(function($translateProvider) {
    $translateProvider.translations('mk-MK', {
      ...
      GPR_7_TH_GRAD: 'Матурирани',
      GPR_7_TH_UNIENROLLED: 'Запишани на фак.',
      GPR_7_TH_EMPLOYED: 'Вработени',
      GPR_7_TH_UNEMPLOYED: 'Невработени',
      GPR_7_TH_UNKNOWN: 'Непознат статус',
      GPR_8: '',
      GPR_9: '% на запишани студенти по факултет',
      GPR_9_TH_UNI: 'Универзитет',
    ...
    .translations('en-US', {
      ...
      GPR_7_TH_GRAD: 'Graduated',
      GPR_7_TH_UNIENROLLED: 'Enrolled in university',
      GPR_7_TH_EMPLOYED: 'Employed',
      GPR_7_TH_UNEMPLOYED: 'Unemployed',
      GPR_7_TH_UNKNOWN: 'Unknown status',
      GPR_8: '',
      GPR_9: '% of enrolled students per faculty',
      GPR_9_TH_UNI: 'University',
